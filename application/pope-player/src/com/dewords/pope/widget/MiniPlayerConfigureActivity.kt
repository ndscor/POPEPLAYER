...
import com.dewords.pope.databinding.WidgetMiniPlayerConfigureBinding
import com.dewords.pope.gui.BaseActivity
import com.dewords.pope.gui.dialogs.WidgetExplanationDialog
import com.dewords.pope.gui.helpers.bitmapFromView
import com.dewords.pope.gui.preferences.widgets.PreferencesWidgets
import com.dewords.pope.gui.preferences.widgets.WIDGET_ID
...
class MiniPlayerConfigureActivity : BaseActivity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // If this activity was started with an intent without an com.dewords.pope.app widget ID, finish with an error.
        ...
        model.widget.value?.let {widget ->
            lifecycleScope.launch {
                withContext((Dispatchers.IO)) {
                        val coverBitmap = BitmapFactory.decodeResource(resources, R.mipmap.pope_launcher)
