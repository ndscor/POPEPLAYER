...
import com.dewords.pope.databinding.DialogWidgetExplanationBinding
...
class WidgetExplanationDialog : VLCBottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val sizeDrawbles = listOf(R.mipmap.pope_launcher, R.mipmap.pope_launcher, R.mipmap.pope_launcher, R.mipmap.pope_launcher)
...
private class ResizeHandler(owner: WidgetExplanationDialog) : WeakHandler<WidgetExplanationDialog>(owner) {
    private val sizeDrawables = listOf(R.mipmap.pope_launcher, R.mipmap.pope_launcher, R.mipmap.pope_launcher, R.mipmap.pope_launcher)
    var currentDrawable = R.mipmap.pope_launcher
