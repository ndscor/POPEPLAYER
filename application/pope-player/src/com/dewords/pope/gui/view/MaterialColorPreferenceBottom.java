...
import static com.dewords.pope.interfaces.DialogFragment.tintButtons;
...
import com.dewords.pope.interfaces.ColorPalette;
import com.dewords.pope.interfaces.LineColorPicker;
 ...
 */
public class MaterialColorPreferenceBottom extends Preference {
    ...
    public MaterialColorPreferenceBottom(Context context) {
        super(context);
        initAttrs(null, 0);
    }

    public MaterialColorPreferenceBottom(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(attrs, 0);
    }

    public MaterialColorPreferenceBottom(Context context, AttributeSet attrs, int defStyle) {
    ...
    public static class ColorDialogFragment extends DialogFragment {
        private MaterialColorPreferenceBottom mPreference;
        ...
        public void setPreference(MaterialColorPreferenceBottom preference) {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            int color = PreferencesActivity.Companion.getPrimaryColor();
            if(colorType == 0){
                ...
                color = PreferencesActivity.Companion.getAccentColor();
            ...
            mColorPicker.setOnColorChangedListener(new LineColorPicker.OnColorChangedListener() {
                ...
                public void onColorChanged(int c) {
                    ...
                    if(colorType == 0) {
                        ...
                        ((PreferencesActivity)getActivity()).changebottombar(mColorPicker.getColor());
            ...
            builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    if(colorType == 0) {
                        ...
                        PreferencesActivity.Companion.setAccentColor(ColorPalette.getAccentColor(context, mColorPicker.getColor()));
                    } else if (colorType == 1) {
            ...
            builder.setNegativeButton(android.R.string.cancel, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    if(colorType == 0) {
                        ((PreferencesActivity)getActivity()).changeActionBarColor(PreferencesActivity.Companion.getPrimaryColor());
                    }
                    dismiss();
                }
            });
