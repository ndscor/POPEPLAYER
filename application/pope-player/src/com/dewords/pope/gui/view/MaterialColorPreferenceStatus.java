 ...
 */
public class MaterialColorPreferenceStatus extends Preference {
    ...
    public MaterialColorPreferenceStatus(Context context) {
        super(context);
        initAttrs(null, 0);
    }

    public MaterialColorPreferenceStatus(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(attrs, 0);
    }

    public MaterialColorPreferenceStatus(Context context, AttributeSet attrs, int defStyle) {
    ...
    public static class ColorDialogFragment extends DialogFragment {
        private MaterialColorPreferenceStatus mPreference;
        ...
        public void setPreference(MaterialColorPreferenceStatus preference) {
            ...
            mColorPicker.setOnColorChangedListener(new LineColorPicker.OnColorChangedListener() {
                ...
                public void onColorChanged(int c) {
                    ...
                    if(colorType == 0) {
                        ...
                        ((PreferencesActivity)getActivity()).changeStatusbar(mColorPicker.getColor());
