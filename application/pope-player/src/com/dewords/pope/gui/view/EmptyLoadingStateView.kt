...
class EmptyLoadingStateView : FrameLayout {
    ...
    var state = EmptyLoadingState.LOADING
        set(value) {
            ...
            emptyImageView.setImageBitmap(context.getBitmapFromDrawable(if (value == EmptyLoadingState.EMPTY_FAVORITES) R.mipmap.pope_launcher else if (value in arrayOf(EmptyLoadingState.EMPTY, EmptyLoadingState.EMPTY_SEARCH, EmptyLoadingState.EMPTY_FAVORITES)) R.mipmap.pope_launcher else R.drawable.round_warning_24))
