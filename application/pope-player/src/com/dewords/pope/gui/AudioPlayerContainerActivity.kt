...
import com.dewords.pope.gui.audio.AudioPlaylistTipsDelegate
import com.dewords.pope.gui.audio.AudioTipsDelegate
...
open class AudioPlayerContainerActivity : BaseActivity(), KeycodeListener {
    ...
    protected open fun initAudioPlayerContainerActivity() {
        ...
        tabLayout?.viewTreeObserver?.addOnGlobalLayoutListener {
            ...
            if (AndroidUtil.isLolliPopOrLater) appBarLayout.elevation = if (needToElevate) 0.dp.toFloat() else 0.dp.toFloat()
        }
