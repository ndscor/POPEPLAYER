...
open class SelectorViewHolder<T : ViewDataBinding>(vdb: T) : RecyclerView.ViewHolder(vdb.root) {
    ...
    var binding: T = vdb
    private val ITEM_FOCUS_ON: Int = ContextCompat.getColor(vdb.root.context, R.color.blue900transparent)
    private val ITEM_FOCUS_OFF: Int = ContextCompat.getColor(vdb.root.context, R.color.transparent)
    private val ITEM_SELECTION_ON: Int = ContextCompat.getColor(vdb.root.context, R.color.blue900transparent)
