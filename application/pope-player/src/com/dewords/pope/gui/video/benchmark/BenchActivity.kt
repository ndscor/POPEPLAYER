...
class BenchActivity : ShallowVideoPlayer() {
    ...
    *  saved, to be restored at the end of the test */
    ...
    /* Get a time limit from the benchmark com.dewords.pope.app after which playback should be stopped
    ...
    *  extend the length of the benchmark*/
    ...
    companion object {
        ...
        private const val ACTION_TRIGGER_SCREENSHOT = "com.dewords.popebenchmark.TRIGGER_SCREENSHOT"
        private const val ACTION_CONTINUE_BENCHMARK = "com.dewords.pope.gui.video.benchmark.CONTINUE_BENCHMARK"
