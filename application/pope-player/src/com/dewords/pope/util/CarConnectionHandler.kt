...
private const val CAR_CONNECTION_AUTHORITY = "androidx.car.com.dewords.pope.app.connection"
...
internal class CarConnectionHandler(resolver: ContentResolver?) : AsyncQueryHandler(resolver) {
    ...
    override fun onQueryComplete(token: Int, cookie: Any?, cursor: Cursor?) {
     ...
     companion object {
         const val RECEIVER_ACTION = "androidx.car.com.dewords.pope.app.connection.action.CAR_CONNECTION_UPDATED"
