...
public class HistoryItemCardBindingImpl extends HistoryItemCardBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.song_marker, 11);
    }
    // views
    @NonNull
    ...
    public HistoryItemCardBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 12, sIncludes, sViewsWithIds));
    }
    private HistoryItemCardBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.isNetwork == variableId) {
            ...
            setHolder((com.dewords.pope.gui.HistoryAdapter.ViewHolder) variable);
        }
    ...
    public void setHolder(@Nullable com.dewords.pope.gui.HistoryAdapter.ViewHolder Holder) {
        this.mHolder = Holder;
        synchronized(this) {
            mDirtyFlags |= 0x8L;
        }
    ...
    protected void executeBindings() {
        ...
        com.dewords.pope.gui.HistoryAdapter.ViewHolder holder = mHolder;
        ...
        if ((dirtyFlags & 0x88L) != 0) {
            ...
            this.mboundView1.setOnClickListener(holderOnClickAndroidViewViewOnClickListener);
            this.mboundView1.setOnLongClickListener(holderOnLongClickAndroidViewViewOnLongClickListener);
        }
        if ((dirtyFlags & 0x84L) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0x90L) != 0) {
            ...
            com.dewords.pope.gui.helpers.ImageLoaderKt.loadImage(this.icon, media, (int)0, (boolean)false, (boolean)false);
            com.dewords.pope.util.AccessibilityHelperKt.mediaDescription(this.mboundView1, media);
            ...
            com.dewords.pope.util.KextensionsKt.asyncText(this.title, mediaTitle);
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.dewords.pope.gui.HistoryAdapter.ViewHolder value;
        public OnClickListenerImpl setValue(com.dewords.pope.gui.HistoryAdapter.ViewHolder value) {
            this.value = value;
    ...
    public static class OnLongClickListenerImpl implements android.view.View.OnLongClickListener{
        private com.dewords.pope.gui.HistoryAdapter.ViewHolder value;
        public OnLongClickListenerImpl setValue(com.dewords.pope.gui.HistoryAdapter.ViewHolder value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl1 implements android.view.View.OnClickListener{
        private com.dewords.pope.gui.HistoryAdapter.ViewHolder value;
        public OnClickListenerImpl1 setValue(com.dewords.pope.gui.HistoryAdapter.ViewHolder value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    /* flag mapping
        ...
        flag 20 (0x15L): isOTG ? media.isPresent : false
        flag 21 (0x16L): isOTG ? media.isPresent : false
        flag 22 (0x17L): media.isPresent ? View.GONE : View.VISIBLE
        flag 23 (0x18L): media.isPresent ? View.GONE : View.VISIBLE
    flag mapping end*/
    //end
}