...
import com.dewords.television.ui.browser.REQUEST_CODE_RESTART_APP
import com.dewords.television.ui.dialogs.ConfirmationTvActivity
import org.videolan.tools.*
import com.dewords.pope.R
import com.dewords.pope.gui.dialogs.FeatureTouchOnlyWarningDialog
...
class PreferencesUi : BasePreferenceFragment(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findPreference<Preference>(KEY_APP_COLOR)?.isEnabled = false
