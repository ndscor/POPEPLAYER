...
import com.dewords.pope.util.scanAllowed
                ...
                item.metadata.mlId?.let {
                    viewModelScope.launch {
                        context.getFromMl {
                            ...
                            val intent = Intent(activity, com.dewords.television.ui.DetailsActivity::class.java)
                            // pass the item information
                            intent.putExtra("media", it)
                            intent.putExtra("item", com.dewords.television.ui.MediaItemDetails(it.title, it.artist, it.album, it.location, it.artworkURL))
                            activity.startActivity(intent)
                        }
                    }
                }
            }
            is MediaLibraryItem -> com.dewords.television.ui.TvUtil.openAudioCategory(activity, item)
        }
    }
