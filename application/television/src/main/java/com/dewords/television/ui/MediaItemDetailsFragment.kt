...
import com.dewords.pope.repository.MediaMetadataRepository
import com.dewords.pope.repository.MediaPersonRepository
...
import com.dewords.poperesources.FAVORITE_TITLE
import com.dewords.poperesources.HEADER_DIRECTORIES
import com.dewords.poperesources.HEADER_NETWORK
...
import com.dewords.pope.gui.DialogActivity.Companion.EXTRA_MEDIA
import com.dewords.pope.gui.helpers.AudioUtil
import com.dewords.pope.gui.helpers.UiTools
import com.dewords.pope.gui.helpers.UiTools.addToPlaylist
...
class MediaItemDetailsFragment : DetailsSupportFragment(), CoroutineScope by MainScope(), OnItemViewClickedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val hasMedia = extras.containsKey(com.dewords.television.ui.EXTRA_MEDIA)
        fromHistory = extras.getBoolean(EXTRA_FROM_HISTORY, false)
        val media = (extras.parcelable<Parcelable>(com.dewords.television.ui.EXTRA_MEDIA)
        ...
        viewModel.browserFavUpdated.observe(this, Observer { newMedia ->
            ...
            intent.putExtra(com.dewords.television.ui.EXTRA_MEDIA, newMedia)
...
//        buildDetails()
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putParcelable(com.dewords.television.ui.EXTRA_MEDIA, viewModel.media)
