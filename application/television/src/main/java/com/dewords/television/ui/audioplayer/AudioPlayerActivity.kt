 ...
 */
package com.dewords.television.ui.audioplayer
...
import com.dewords.television.databinding.TvAudioPlayerBinding
...
import com.dewords.pope.viewmodels.PlayerState
...
class AudioPlayerActivity : BaseTvActivity(),KeycodeListener  {
    ...
    fun update(state: PlayerState?) {
        ...
        binding.buttonPlay.contentDescription = getString(if (state.playing) com.dewords.pope.R.string.pause else com.dewords.pope.R.string.play)
        ...
        lifecycleScope.launch {
            ...
            binding.buttonShuffle.contentDescription = getString(if (shuffling) com.dewords.pope.R.string.shuffle_on else com.dewords.pope.R.string.shuffle)
    ...
    override fun bookmark() {
        ...
        UiTools.snackerConfirm(this, getString(com.dewords.pope.R.string.bookmark_added), confirmMessage = com.dewords.pope.R.string.show) {
            showBookmarks()
        }
    }
