...
import com.dewords.television.ui.TvUtil.diffCallback
import com.dewords.television.ui.TvUtil.metadataDiffCallback
import com.dewords.television.ui.audioplayer.AudioPlayerActivity
import com.dewords.television.ui.browser.VerticalGridActivity
import com.dewords.television.ui.preferences.PreferencesActivity
import com.dewords.television.viewmodel.MainTvModel
import com.dewords.television.viewmodel.MainTvModel.Companion.getMainTvModel
import com.dewords.pope.R
import com.dewords.pope.RecommendationsService
//import com.dewords.pope.donations.BillingStatus
//import com.dewords.pope.donations.VLCBilling
import com.dewords.pope.gui.helpers.UiTools.showDonations
...
class MainTvFragment : BrowseSupportFragment(), OnItemViewSelectedListener, OnItemViewClickedListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        badgeDrawable = ContextCompat.getDrawable(requireContext(), R.mipmap.pope_launcher)

        //Enable search feature only if we detect Google Play Services.
        if (AndroidDevices.hasPlayServices) {
            setOnSearchClickedListener(this)
            // set search icon color
            searchAffordanceColor = ContextCompat.getColor(requireContext(), R.color.blue900)
        }
        brandColor = ContextCompat.getColor(requireContext(), R.color.blue900)
...
//        rowsAdapter.add(playlistRow)
        ...
        otherAdapter.add(GenericCardItem(ID_ABOUT_TV, getString(R.string.about), "${getString(R.string.app_name_full)} ", R.drawable.ic_menu_info_big, R.color.tv_card_content_dark))
