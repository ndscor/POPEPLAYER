...
import com.dewords.pope.database.models.getYear
import com.dewords.pope.database.models.subtitle
import com.dewords.pope.database.models.tvEpisodeSubtitle
import com.dewords.pope.repository.MediaMetadataRepository
import com.dewords.poperesources.CONTENT_EPISODE
import com.dewords.poperesources.CONTENT_RESUME
import org.videolan.tools.Settings
import com.dewords.pope.R
import com.dewords.pope.getFileUri
                        ...
                        mediaMetadataWithImages.metadata.mlId?.let { mlId ->
                            ...
                            matrixCursor.addRow(arrayOf(media.id, "media_${media.id}", mediaMetadataWithImages.metadata.title, mediaMetadataWithImages.subtitle(), thumbnail, mediaMetadataWithImages.metadata.getYear(), media.length))
                                ...
                                ?: if (mediaMetadataWithImages.metadata.type == MediaMetadataType.TV_SHOW) {
                                    val provider = com.dewords.pope.provider.MediaScrapingTvshowProvider(context)
